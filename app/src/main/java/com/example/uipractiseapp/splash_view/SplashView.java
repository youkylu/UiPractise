package com.example.uipractiseapp.splash_view;
...
public class SplashView  extends View {
    ...
    private void drawCircles(Canvas canvas){
        ...
        for(int i=0; i< mCircleColors.length;i++){
            ...
            float cx = (float) (Math.cos(angel)*mCurrentRotateRadius + mCenterX);
            float cy = (float) (Math.sin(angel)*mCurrentRotateRadius+mCenterY);
